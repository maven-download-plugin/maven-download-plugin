...
```
mvn com.googlecode.maven-download-plugin:download-maven-plugin:1.8.1:artifact -DgroupId=com.googlecode -DartifactId=maven-download-plugin -Dversion=0.1 -DoutputDirectory=temp
```
...
See also generated documentation pages [for 1.8.1](http://maven-download-plugin.github.io/maven-download-plugin/docsite/1.8.0/) and [for snapshot](http://maven-download-plugin.github.io/maven-download-plugin/docsite/snapshot/).

...
```
mvn com.googlecode.maven-download-plugin:download-maven-plugin:1.5.1:artifact -DgroupId=com.googlecode -DartifactId=maven-download-plugin -Dversion=0.1 -DoutputDirectory=temp
```
...
See also generated documentation pages [for 1.5.1](http://maven-download-plugin.github.com/maven-download-plugin/docsite/1.5.1/) and [for snapshot](http://maven-download-plugin.github.com/maven-download-plugin/docsite/snapshot/).

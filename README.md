...
```
mvn com.googlecode.maven-download-plugin:download-maven-plugin:1.2.1:artifact -DgroupId=com.googlecode -DartifactId=maven-download-plugin -Dversion=0.1 -DoutputDirectory=temp
```
